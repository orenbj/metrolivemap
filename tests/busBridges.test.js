...
describe('_bridgePolyline — bracket geometry', () => {
    ...
    it('offsets the midpoint perpendicular to A→B by ~150 m (east-west pair)', () => {
        ...
        expect(dist).toBeGreaterThan(149);
        expect(dist).toBeLessThan(151);
    ...
    it('offsets the midpoint perpendicular to A→B by ~150 m (north-south pair)', () => {
    ...
    it('offsets by ~150 m on a 45° diagonal', () => {
