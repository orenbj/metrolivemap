...
describe('_bridgePolyline — bracket geometry', () => {
    ...
    it('offsets the midpoint perpendicular to A→B by ~240 m (east-west pair)', () => {
        ...
        expect(dist).toBeGreaterThan(239);
        expect(dist).toBeLessThan(241);
    ...
    it('offsets the midpoint perpendicular to A→B by ~240 m (north-south pair)', () => {
    ...
    it('offsets by ~240 m on a 45° diagonal', () => {
