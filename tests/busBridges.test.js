...
describe('_bridgePolyline — bracket geometry', () => {
    ...
    it('offsets the midpoint perpendicular to A→B by ~120 m (east-west pair)', () => {
    ...
    it('offsets the midpoint perpendicular to A→B by ~120 m (north-south pair)', () => {
    ...
    it('offsets by ~120 m on a 45° diagonal', () => {
