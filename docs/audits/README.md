...
|---|---|---|
| [`full-app-review-2026-09-02.md`](./full-app-review-2026-09-02.md) | Whole application, ten dimensions: rider UX/mobile, motion, ETA/feed data, station popup, badges/bridges, security/privacy, a11y, performance/resilience, secondary features, CI/pipeline/tests, docs. Every finding independently reproduced or refuted before listing. 60 confirmed (7 high, 35 medium, 18 low), 2 plausible, 24 unverified low/cosmetic. | **Open** — awaiting triage. No live-site capture ran (see "Honest limits"). |
