...
export function initMap() {
    ...
    class CustomControls {
        onAdd(map) {
            ...
            // Globe — opens the browser's built-in translate flow. There's no
            // JS API to invoke that flow directly; the button exists to make
            // the affordance discoverable and to surface the platform-specific
            // gesture (right-click on desktop, AA menu on iOS Safari, etc.).
